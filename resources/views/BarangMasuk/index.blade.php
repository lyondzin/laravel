...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
  ...
  <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
      <div>
          <h3 class="text-lg font-semibold text-slate-800">Barang Masuk</h3>
          <p class="text-slate-500">A list of all the Barang Masuk..</p>
      </div>
      <div class="ml-3">
      ...
      <tr class="hover:bg-slate-50 border-b border-slate-200">
          ...
          <td class="p-4 py-5">
           ...
           <a href="{{ route('BarangMasuk.destroy', $BarangMasuk->id) }}"
                   ...
                   onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this data?')) { document.getElementById('delete-form-{{ $BarangMasuk->id }}').submit(); }">
                    Hapus
                </a>
