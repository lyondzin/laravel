...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
  ...
  <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
      <div>
          ...
          <p class="text-slate-500">A list of all the Stok...</p>
      </div>
      <div class="ml-3">
      ...
      <tr class="hover:bg-slate-50 border-b border-slate-200">
          ...
          <td class="p-4 py-5">
           ...
           <a href="{{ route('stok.destroy', $stok->id) }}"
                   ...
                   onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this user?')) { document.getElementById('delete-form-{{ $stok->id }}').submit(); }">
                    Delete
                </a>
